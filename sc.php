...
function  create() {
    ...
    if (myid.value=="" || url.value=="8"){
        alert("ID或跳转地址不能为空！");
        return false;
    }
    kd.href = 'https://cnhackteam.com/?id=8'+myid.value+'&url='+url.value; 
    kd.style = ''; 
    kd.innerText = 'https://cnhackteam.com/?id=8'+myid.value+'&url=www.baidu.com'+url.value; 
}
   </script>
